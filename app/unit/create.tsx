...
import { createUnit } from '@/hooks/useDatabase';
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="flex-row items-center px-4 py-4 mt-6">
        ...
        <Text className="text-2xl font-bold text-foreground">Create Unit</Text>
      </View>
      ...
      <ScrollView className="flex-1">
        <View className="p-4">
          ...
          >
            <Text className="text-lg font-bold">{isSubmitting ? 'Creating...' : 'Create Unit'}</Text>
          </Button>
        </View>
        <View className="h-20" />
      </ScrollView>
